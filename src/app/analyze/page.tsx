      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 mb-6 shadow-sm">
          <textarea
            ...
            className="w-full h-72 text-sm text-gray-900 placeholder-gray-300 resize-none outline-none leading-relaxed font-mono bg-gray-50 rounded-xl p-4 border border-gray-100 focus:border-blue-500 focus:bg-white transition-colors"
          />
          {errorMsg && (
